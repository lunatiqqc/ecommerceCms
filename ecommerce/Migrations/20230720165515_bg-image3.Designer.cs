...
namespace ecommerce.Migrations
{
    ...
    [Migration("20230720165515_bg-image3")]
    partial class bgimage3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cms.models.styling.Background", b =>
                {
                    ...
                    b.Property<int?>("BackgroudImageId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("BackgroudImageId");
            ...
            modelBuilder.Entity("cms.models.styling.Background", b =>
                {
                    b.HasOne("cms.models.styling.ImageStyle", "BackgroudImage")
                        .WithMany()
                        .HasForeignKey("BackgroudImageId");

                    b.Navigation("BackgroudImage");
                });
