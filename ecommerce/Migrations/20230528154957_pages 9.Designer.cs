...
namespace ecommerce.Migrations
{
    ...
    [Migration("20230528154957_pages 9")]
    partial class pages9
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("cms.Models.Component", b =>
                {
                    ...
                    b.Property<string>("Discriminator2")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasDiscriminator<string>("Discriminator2").HasValue("Component");
            ...
            modelBuilder.Entity("cms.Models.GridColumn", b =>
                {
                    ...
                    b.Property<int?>("BaseComponentId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("cms.Models.ImageComponent", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ImageComponent");
                });
            ...
            modelBuilder.Entity("cms.Models.TextComponent", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("TextComponent");
                });
