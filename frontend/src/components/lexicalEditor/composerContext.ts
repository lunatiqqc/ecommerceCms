...
export function setImageHistoryPluginType(componentTypeRef: SvelteComponentTypeRef) {
	getSharedEditorContext().ImageHistoryComponentType = componentTypeRef;
}

export function getImageHistoryPluginType() {
	return getSharedEditorContext().ImageHistoryComponentType as SvelteComponentTypeRef;
}
