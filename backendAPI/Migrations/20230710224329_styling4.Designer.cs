...
namespace ecommerce.Migrations
{
    ...
    [Migration("20230710224329_styling4")]
    partial class styling4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cms.models.styling.BaseStyling", b =>
                {
                    ...
                    b.HasDiscriminator<string>("ContentContainer").HasValue("BaseStyling");
            ...
            modelBuilder.Entity("cms.models.GridColumn", b =>
                {
                    b.HasBaseType("cms.models.styling.BaseStyling");
                    ...
                    b.ToTable("BaseStyling", t =>
                        {
                            t.Property("GridContentId")
                                .HasColumnName("GridColumn_GridContentId");
                        });

                    b.HasDiscriminator().HasValue("GridColumn");
                });
            ...
            modelBuilder.Entity("cms.models.GridRow", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("GridRow");
                });
